...
//                swipeLayout = (SwipeRefreshLayout) findViewById(MResource.getIdByName(getApplication(), "id", "swipe_container"));
    ...
    private void openUrl() {
        ...
        webView.loadUrl(allUrl);//"https://h5.51xianwan.com/try/try_list_plus.aspx?ptype=2" + "&deviceid=" + imei + "&appid=" + appid + "&appsign=" + appsign + "&keycode=" + keycode
