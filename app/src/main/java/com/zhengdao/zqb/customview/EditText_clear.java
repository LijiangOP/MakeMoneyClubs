...
public class EditText_clear extends android.support.v7.widget.AppCompatEditText {
     ...
     */
    private void init() {
        clearDrawable = getResources().getDrawable(R.drawable.turnout);
        searchDrawable = getResources().getDrawable(R.drawable.taobao_fragment_search);
