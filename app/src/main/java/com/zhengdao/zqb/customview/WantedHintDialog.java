...
/**
 * @Author lijiangop
 * @CreateTime 2017/9/27 09:20
 */
public class WantedHintDialog extends Dialog {
    ...
    public WantedHintDialog(Context context) {
    ...
    private void initView() {
        ...
        View inflate = from.inflate(R.layout.layout_wanted_hint_dialog, null);
