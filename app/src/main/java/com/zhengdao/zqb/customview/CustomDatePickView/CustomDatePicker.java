package com.zhengdao.zqb.customview.CustomDatePickView;
...
public class CustomDatePicker {
    ...
    public interface ResultHandler {
        void handle(String time, String stime);
    }
    ...
    private boolean       canAccess = false, mIsLeftChoose;
    ...
    private String mStartPreTime, mEndPreTime;//用户选择显示的时间
    private boolean mIsShowUnit = true;//是否显示年月日这三个单位 默认显示
    private ArrayList<String> year, month, day, hour, minute;
    private int startYear, startMonth, startDay, startHour, startMinute, endYear, endMonth, endDay, endHour, endMinute;
    private boolean spanYear, spanMon, spanDay, spanHour, spanMin;
    private Calendar selectedCalender, startCalendar, endCalendar;
    private TextView tv_cancle, tv_select, mTvTimeStart, mTvTimeEnd, mTvUnitYear, mTvUnitMonth, mTvUnitDay, mHourText, mMinuteText;
    ...
    private void initView() {
        ...
        mTvTimeStart = datePickerDialog.findViewById(R.id.tv_time_start);
        mTvTimeEnd = datePickerDialog.findViewById(R.id.tv_time_end);

        mTvUnitYear = datePickerDialog.findViewById(R.id.tv_unit_year);
        mTvUnitMonth = datePickerDialog.findViewById(R.id.tv_unit_month);
        mTvUnitDay = datePickerDialog.findViewById(R.id.tv_unit_day);
        mHourText = datePickerDialog.findViewById(R.id.hour_text);
        mMinuteText = datePickerDialog.findViewById(R.id.minute_text);

        setTvChoose(mTvTimeEnd, false);
        setTvChoose(mTvTimeStart, true);
        mIsLeftChoose = true;
        ...
        mTvTimeEnd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                setTvChoose(mTvTimeEnd, true);
                setTvChoose(mTvTimeStart, false);
                setSelectedTime(mEndPreTime);
                mIsLeftChoose = false;
            }
        });
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                handler.handle(mTvTimeStart.getText().toString().trim(), mTvTimeEnd.getText().toString().trim());
                datePickerDialog.dismiss();
            }
        });
    }

    private void setTvChoose(TextView textView, boolean isChoose) {
        if (isChoose) {
            textView.setTextColor(context.getResources().getColor(R.color.blue));
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN)
                textView.setBackground(context.getResources().getDrawable(R.drawable.shape_only_bottom_blue));
        } else {
            textView.setTextColor(context.getResources().getColor(R.color.black));
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN)
                textView.setBackground(context.getResources().getDrawable(R.drawable.shape_only_bottom_gray));
        }
    }
    ...
    private void addListener() {
        ...
        day_pv.setOnSelectListener(new DatePickerView.onSelectListener() {
            ...
            public void onSelect(String text) {
                ...
                if (mIsLeftChoose) {
                    mTvTimeStart.setText(sdf.format(selectedCalender.getTime()));
                    mStartPreTime = sdf.format(selectedCalender.getTime());
                } else {
                    mTvTimeEnd.setText(sdf.format(selectedCalender.getTime()));
                    mEndPreTime = sdf.format(selectedCalender.getTime());
                }
            }
        });
        ...
        if (canAccess) {
            if (isValidDate(time, "yyyy-MM-dd")) {
                if (startCalendar.getTime().getTime() < endCalendar.getTime().getTime()) {
                    ...
                    mStartPreTime = time;
                    if (mIsShowUnit) {
                        mTvUnitYear.setVisibility(View.VISIBLE);
                        mTvUnitMonth.setVisibility(View.VISIBLE);
                        mTvUnitDay.setVisibility(View.VISIBLE);
                    } else {
                        mTvUnitYear.setVisibility(View.GONE);
                        mTvUnitMonth.setVisibility(View.GONE);
                        mTvUnitDay.setVisibility(View.GONE);
                    }
                    mTvTimeStart.setText(mStartPreTime);
                    mTvTimeEnd.setText(mEndPreTime);
                }
            } else {
                canAccess = false;
            }
     ...
     * @param isShowUnit
     */
    public void isShowUnit(boolean isShowUnit) {
        mIsShowUnit = isShowUnit;
    }
