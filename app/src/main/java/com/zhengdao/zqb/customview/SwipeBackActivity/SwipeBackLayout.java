 ...
 * Class Note:
 * 1 swipe back layout which extends from FrameLayout
 * 2 using {@link ViewDragHelper} to process drag and touch event
 * 3 support four direction drag
 */
public class SwipeBackLayout extends FrameLayout {
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        /*1 create instance of ViewDragHelper*/
        mDragHelper = ViewDragHelper.create(this, 1.0f, new ViewDragCallback());

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.UST_activity, defStyle,
                R.style.UST_SwipeBackLayout);

        int edgeSize = a.getDimensionPixelSize(R.styleable.UST_activity_UST_edge_size, -1);
        if (edgeSize > 0)
            setEdgeSize(edgeSize);
        int mode = EDGE_FLAGS[a.getInt(R.styleable.UST_activity_UST_edge_flag, 0)];

        setEdgeTrackingEnabled(mode);

        //drawable shadow effect of four direction
        int shadowLeft = a.getResourceId(R.styleable.UST_activity_UST_shadow_left,
                R.drawable.shadow_left);
        int shadowRight = a.getResourceId(R.styleable.UST_activity_UST_shadow_right,
                R.drawable.shadow_right);
        int shadowBottom = a.getResourceId(R.styleable.UST_activity_UST_shadow_bottom,
                R.drawable.shadow_bottom);
        int shadowTop = a.getResourceId(R.styleable.UST_activity_UST_shadow_top,
    ...
    /*2 process onInterceptTouchEvent and onTouchEvent in ViewDragHelper*/
    @Override
    ...
    /*3 implement methods in  ViewDragHelper.Callback*/
