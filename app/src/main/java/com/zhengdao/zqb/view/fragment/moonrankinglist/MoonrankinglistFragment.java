...
public class MoonrankinglistFragment extends MVPBaseFragment<MoonrankinglistContract.View, MoonrankinglistPresenter> implements MoonrankinglistContract.View {
    ...
    protected View getFragmentView() {
        View view = View.inflate(getActivity(), R.layout.moonrankinglist_fragment, null);
