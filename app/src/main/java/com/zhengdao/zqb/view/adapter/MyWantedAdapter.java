...
/**
 * @Author lijiangop
 * @CreateTime 2018/5/17 09:33
 */
public class MyWantedAdapter extends RecyclerView.Adapter {
    ...
    private List<MyWantedDetailEntity> mData;
    ...
    public MyWantedAdapter(Context context, List data, ViewEventCallBack callback) {
        mData = data;
        mContext = context;
        mCallback = callback;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(View.inflate(mContext, R.layout.item_my_wanted, null));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        try {
            ...
            final MyWantedDetailEntity bean = mData.get(position);
